...
module Inferno
  module Sequence
    class USCore311CernerCareplanSequence < SequenceBase
      include Inferno::DataAbsentReasonChecker
      include Inferno::USCore311ProfileDefinitions

      title 'Cerner CarePlan Tests'

      description 'Verify support for the server capabilities required by the US Core Cerner CarePlan Profile.'
